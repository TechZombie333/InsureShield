...
contract Marketplace is ReentrancyGuard {
    ...
    function requestClaim(uint256 itemId, uint256 claimPrice) public {
        ...
        message memory newMessage = message(
            ...
            itemId,
            claimPrice,
            "I am claiming Insurance for my car"
        );
    ...
    function sendClaim(
        ...
        message memory newMessage = message(
            ...
            itemId,
            claimPrice * unit,
            "Your claim for Insurance is approved and sent"
        );
    ...
    function checkActive(uint itemId) public {
        if (
            itemDetails[itemId].timestamp + itemDetails[itemId].duration <=
            block.timestamp
        ) {
